    ...
    <header className={`w-full sticky top-0 z-50 transition-all duration-300 ${isScrolled ? 'backdrop-blur-md bg-background/30' : 'bg-transparent'}`}>
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-3 md:py-4">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <Link 
            to="/ingressos"
            className="sm:hidden flex items-center justify-center px-4 rounded-full h-10 font-bold text-xs uppercase bg-gradient-to-r from-[hsl(38,100%,50%)] to-[hsl(45,100%,50%)] text-black shadow-lg hover:shadow-xl transition-all"
          >
            Ingressos
          </Link>
