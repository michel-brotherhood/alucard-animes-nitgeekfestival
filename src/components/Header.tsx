    ...
    <header className={`w-full sticky top-0 z-50 transition-all duration-300 ${isScrolled ? 'backdrop-blur-md bg-background/30' : 'bg-transparent'}`}>
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-3 md:py-4">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          <Link 
            to="/ingressos"
            className="hidden sm:inline-flex items-center justify-center px-6 rounded-full h-11 font-black text-sm uppercase bg-gradient-to-r from-[hsl(38,100%,50%)] via-[hsl(45,100%,55%)] to-[hsl(45,100%,50%)] bg-size-200 bg-pos-0 hover:bg-pos-100 transition-all duration-500 text-[hsl(210,100%,20%)] shadow-[0_0_20px_rgba(255,193,7,0.5)] hover:shadow-[0_0_30px_rgba(255,193,7,0.8)] hover:scale-105 relative overflow-hidden group"
          >
          ...
          <Link 
            to="/ingressos"
            className="sm:hidden flex items-center justify-center px-4 rounded-full h-10 font-bold text-xs uppercase bg-gradient-to-r from-[hsl(38,100%,50%)] to-[hsl(45,100%,50%)] text-[hsl(210,100%,20%)] shadow-lg hover:shadow-xl transition-all"
          >
            Ingressos
          </Link>
