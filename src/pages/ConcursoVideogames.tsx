          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              {jogos.map((jogo, index) => (
                <Card key={index} className="overflow-hidden group hover:scale-105 transition-all duration-300 hover:shadow-2xl border-0">
                  <div className="relative h-80 overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6">
                      <h3 className="text-white text-2xl font-bold mb-1 drop-shadow-lg">{jogo.title}</h3>
                      <p className="text-white/90 text-sm font-medium drop-shadow-md">{jogo.categoria}</p>
                    </div>
                  </div>
                </Card>
              ))}
